    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '480px', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: '#666', fontSize: '0.95rem' }}>Start finding high-intent leads in seconds.</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              <label style={{ display: 'block', fontSize: '0.875rem', color: '#a1a1aa', marginBottom: '0.5rem', fontWeight: 500 }}>
                Full Name
              </label>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '2rem 0' }}>
            ...
            <span style={{ color: '#555', fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '1px' }}>or</span>
            <div style={{ flex: 1, height: '1px', background: '#333' }} />
          </div>
          ...
          <button
            ...
            onMouseOver={(e) => { (e.target as HTMLElement).style.borderColor = '#555'; (e.target as HTMLElement).style.background = 'rgba(255,255,255,0.02)'; }}
            onMouseOut={(e) => { (e.target as HTMLElement).style.borderColor = '#333'; (e.target as HTMLElement).style.background = 'transparent'; }}
          >
          ...
          <div style={{ marginTop: '2rem', padding: '1.25rem', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
            <p style={{ fontSize: '0.8rem', color: '#666', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '0.75rem' }}>What you get:</p>
            {['Real-time AI lead scanning', 'Dynamic intent scoring (NLP)', '1-Click smart email outreach', 'CSV export to CRM'].map((feature) => (
              <div key={feature} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.875rem', color: '#a1a1aa' }}>{feature}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: '#666', fontSize: '0.95rem' }}>
          ...
          <a href="/login" style={{ color: '#fff', fontWeight: 600, textDecoration: 'none', transition: 'opacity 0.2s' }}
