    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: '#666', fontSize: '0.95rem' }}>Welcome back. Sign in to continue.</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: '#666', fontSize: '0.95rem' }}>
          ...
          <a href="/signup" style={{ color: '#fff', fontWeight: 600, textDecoration: 'none', transition: 'opacity 0.2s' }}
