                      ...
                      <div style={{ flex: 1, minWidth: '300px' }}>
                        ...
                        <div style={{ background: 'rgba(0,0,0,0.3)', padding: '1rem', borderRadius: '8px', border: `1px solid ${aiOutreach[lead.id] ? '#7c3aed55' : '#333'}`, position: 'relative', marginTop: '1rem' }}>
                          ...
                          <div style={{ position: 'absolute', top: '0.75rem', right: '0.75rem', display: 'flex', gap: '0.75rem' }}>
                            ...
                            <a href={`mailto:${foundEmails[lead.id]?.[0]?.value || lead.contactEmail || ''}?subject=Exploring synergies: ${lead.problem?.replace('Hiring: ', '') || 'Open Role'} at ${lead.company}&body=${encodeURIComponent(aiOutreach[lead.id] || lead.outreach)}`} style={{ color: '#4facfe', padding: 0 }} title="Email"><Mail size={18} /></a>
